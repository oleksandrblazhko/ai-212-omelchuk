...
BEGIN
    ...
    -- Умова №4: Назва психологічної послуги не повинна бути порожньою і не повинна перевищувати 100 символів.
    IF LENGTH(v_psychosvcName) = 0 OR LENGTH(v_psychosvcName) > 100 THEN
        RETURN -4; -- Помилка: Назва психологічної послуги не відповідає умовам.
    END IF;

    -- Всі умови виконані, можна вставляти дані в таблицю.
    INSERT INTO "User" (fullName, address, age, psychosvcName)
    VALUES (v_fullName, v_address, v_age, v_psychosvcName);
    COMMIT;
