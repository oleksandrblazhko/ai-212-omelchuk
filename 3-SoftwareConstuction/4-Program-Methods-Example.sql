...
BEGIN
    ...
    -- Умова №4: Стать користувача повинна відповідати одному з варіантів: "чоловік", "жінка", "інше" і не повинна перевищувати 30 символів.
    IF v_gender NOT IN ('ЧОЛОВІК', 'ЖІНКА', 'ІНШЕ') OR LENGTH(v_gender) > 30 THEN
